        ...
        coefficient_dilation_emg = length(datas.(conditions{condition}).(trials{trial}).Raw.EMG.RMG)/ ...
            length(datas.(conditions{condition}).(trials{trial}).Filtered.EMG.envelope.RMG);
                ...
                if strcmp(markers{marker},'Heel') %If we consider the Heel, we take into account the ANKLE marker
                    ...
                    Healthy_subjects.(subject).(conditions{condition}).(trials{trial}).Event.(leg).HS_emg = ceil((HS*coefficient_dilation_marker)*10/coefficient_dilation_emg); % We put the events in the structure
                    Healthy_subjects.(subject).(conditions{condition}).(trials{trial}).Event.(leg).HO_emg = ceil((HO*coefficient_dilation_marker)*10/coefficient_dilation_emg);
                end
            ...
            if strcmp(markers{marker},'Toe') %If we consider the Toe, we take into account the TOE marker
                ...
                Healthy_subjects.(subject).(conditions{condition}).(trials{trial}).Event.(leg).TS_emg = ceil((TS*coefficient_dilation_marker)*10/coefficient_dilation_emg); % We put the events in the structure
                Healthy_subjects.(subject).(conditions{condition}).(trials{trial}).Event.(leg).TO_emg = ceil((TO*coefficient_dilation_marker)*10/coefficient_dilation_emg);
            end
            end
        end
end
